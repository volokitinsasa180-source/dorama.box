...
async function loadDramas(title = '') {
    const url = title 
    ? `https://kodik-api.com{KODIK_TOKEN}&title=${encodeURIComponent(title)}&limit=12`
    : `https://kodik-api.com{KODIK_TOKEN}&types=foreign-serial,foreign-movie&sort=updated_at&limit=12`;
